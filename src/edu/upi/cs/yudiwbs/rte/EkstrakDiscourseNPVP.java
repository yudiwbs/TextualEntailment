...
public class EkstrakDiscourseNPVP {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        //id=238
        //t="COLOMBO (Reuters) - At least five people were killed and 11 wounded when a suspected Tamil Tiger suicide bomber blew herself up inside a police station in the Sri Lankan capital on Wednesday, shattering more than two years of relative peace.";
        ...
        //id=426
        //t="According to members of Brazilian Court, President Luiz In�cio Lula da Silva may be subjected to an impeachment process, if there is some proof that he is really involved in some of the alleged scandals, or in case someone can prove that he was acting with negligence.";
