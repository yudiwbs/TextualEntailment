 ...
 *
 * Cocok tgl versi NER, mungkin nantinya perlu proses lebih lanjut
 *
 * misal Januari 1940 masuk ke 1940
 *
 */
public class PolaCocokDateNER extends Pola {
    ...
    public boolean isEntail(InfoTeks t, InfoTeks h) {
        ...
        return (skor>0); //>0 asal ada satu yg cocok maka entail true; ==1 harus eksak
    }
