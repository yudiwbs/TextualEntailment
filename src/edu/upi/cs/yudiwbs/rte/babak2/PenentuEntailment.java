 ...
 *
 * lihat ProsesEntailment untuk penggunaan
 */
...
public class PenentuEntailment {
    ...
    ThesaurusSimilarityDB thesaurusSim;
    ...
    public PenentuEntailment() {
        ...
        thesaurusSim = new ThesaurusSimilarityDB();
        thesaurusSim.init("thesaurus_paragraph");
    ...
    public boolean thesaurus(InfoTeks itH,InfoTeks itT) {
       //berdasarkan dokumen hasil search engine google
       //diambil pasangan kata yang sering muncul bersamaan dalam satu kalimat
        ...
        if (pctNounCocok>=0.6 && pctVerbCocok<=0.2 )  {
            ...
            if (pctLemmaCocok>0.3) {
                ...
                double simTheasaurus = 0;

                //String vH = sbVerbHLemma.toString().trim();
                //String vT = sbVerbTLemma.toString().trim();

                //belum support lematisasi
                String vH = itH.getAllVerb();
                String vT = itT.getAllVerb();

                tempStringBuilder.append("Menggunakan thesaurus");
                tempStringBuilder.append(System.lineSeparator());

                //tidak ada verb, misalnya is dst
                //yang dibandingkan  nounnya
                ...
                if (vH.equals("")) {
                    ...
                    //theasurus
                    simTheasaurus = thesaurusSim.hitungSim(itH.id,itH.getAllNoun(),vT,tempStringBuilder);
                    ...
                    tempStringBuilder.append(itH.getAllNoun());
                    tempStringBuilder.append(System.lineSeparator());
                }
                else {
                    //ada verb
                    simTheasaurus = thesaurusSim.hitungSim(itH.id,vH, vT,tempStringBuilder);
                ...
                tempStringBuilder.append(System.lineSeparator());
                tempStringBuilder.append("Skor thesaurus:");
                tempStringBuilder.append(simTheasaurus);
                tempStringBuilder.append(System.lineSeparator());

                //cek batasan skor theasurus
                if (simTheasaurus>0) {
                    isEntail = true;
                    tempStringBuilder.append("Similarity diatas threshold");
                }
            }
        }
